 ...
 * the following clients: 1.12.x, 2.4.3, 3.3.5a, 2.4.3a and 5.4.8
 *
...
namespace proto
{
    ...
    /// Largest packet the 2.4.3 client is ever allowed to send, payload
     ...
     *
     * This is the entire 2.4.3 framing layer and nothing else: it owns no socket,
