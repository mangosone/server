 ...
 * blocks in wait() until the whole tick has been processed. This replaces the ACE
 * DelayExecutor / Method_Request / Activation_Queue machinery with a plain std::thread
 * pool; the public API is unchanged, so MapManager did not have to move with it.
 */
