 ...
 *
 * This core's enum above names nothing past 0x8000, so these are spelled as the raw bits
 * they are. The pair was proven fatal on 3.3.5a and no 2.4.3 template is known to carry it
 * -- the refusal costs nothing and is here so a template ported in cannot bring the crash
 * with it. See TransportMap::EnlistCrew.
 */
