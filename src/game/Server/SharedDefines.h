...
//    AREA_LOCKSTATUS_HAS_BIND                    = 12,
    AREA_LOCKSTATUS_LEVEL_NOT_EQUAL             = 3,
    AREA_LOCKSTATUS_LEVEL_TOO_LOW               = 4,
    AREA_LOCKSTATUS_LEVEL_TOO_HIGH              = 5,
    AREA_LOCKSTATUS_RAID_LOCKED                 = 6,
    AREA_LOCKSTATUS_QUEST_NOT_COMPLETED         = 7,
    AREA_LOCKSTATUS_MISSING_ITEM                = 8,
    AREA_LOCKSTATUS_MISSING_DIFFICULTY          = 9,
    AREA_LOCKSTATUS_ZONE_IN_COMBAT              = 10,
    AREA_LOCKSTATUS_INSTANCE_IS_FULL            = 11,
    AREA_LOCKSTATUS_NOT_ALLOWED                 = 12,
    AREA_LOCKSTATUS_HAS_BIND                    = 13,
    AREA_LOCKSTATUS_WRONG_TEAM                  = 14,
};
