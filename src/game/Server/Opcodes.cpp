...
void InitializeOpcodes()
{
    ...
    OPCODE(MSG_LOOKING_FOR_GROUP,                          STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLookingForGroup);
    OPCODE(CMSG_SET_LOOKING_FOR_GROUP,                     STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleSetLfgOpcode);
    ...
    OPCODE(CMSG_MEETINGSTONE_JOIN,                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    OPCODE(SMSG_MEETINGSTONE_LEAVE,                        STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    ...
    OPCODE(UMSG_UPDATE_ARENA_TEAM_OBSOLETE,                STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    ...
    OPCODE(CMSG_LFG_SET_AUTOJOIN,                          STATUS_AUTHED,   PROCESS_THREADUNSAFE, &WorldSession::HandleLfgSetAutoJoinOpcode);
    OPCODE(CMSG_LFG_CLEAR_AUTOJOIN,                        STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgClearAutoJoinOpcode);
    OPCODE(CMSG_LFM_SET_AUTOFILL,                          STATUS_AUTHED,   PROCESS_THREADUNSAFE, &WorldSession::HandleLfmSetAutoFillOpcode);
    OPCODE(CMSG_LFM_CLEAR_AUTOFILL,                        STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfmClearAutoFillOpcode);
    OPCODE(CMSG_ACCEPT_LFG_MATCH,                          STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    OPCODE(CMSG_DECLINE_LFG_MATCH,                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    OPCODE(CMSG_CANCEL_PENDING_LFG,                        STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    OPCODE(CMSG_CLEAR_LOOKING_FOR_GROUP,                   STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfgClearOpcode);
    OPCODE(CMSG_CLEAR_LOOKING_FOR_MORE,                    STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleLfmClearOpcode);
    OPCODE(CMSG_SET_LOOKING_FOR_MORE,                      STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleSetLfmOpcode);
    OPCODE(CMSG_SET_LFG_COMMENT,                           STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleSetLfgCommentOpcode);
    OPCODE(SMSG_LFG_TIMEDOUT,                              STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    OPCODE(SMSG_LFG_OTHER_TIMEDOUT,                        STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    OPCODE(SMSG_LFG_AUTOJOIN_FAILED,                       STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    OPCODE(SMSG_LFG_AUTOJOIN_FAILED_NO_PLAYER,             STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    OPCODE(SMSG_LFG_LEADER_IS_LFM,                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    OPCODE(SMSG_LFG_UPDATE,                                STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    OPCODE(SMSG_LFG_UPDATE_LFM,                            STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    OPCODE(SMSG_LFG_UPDATE_LFG,                            STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    OPCODE(SMSG_LFG_UPDATE_QUEUED,                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    OPCODE(SMSG_LFG_PENDING_INVITE,                        STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    OPCODE(SMSG_LFG_PENDING_MATCH,                         STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    OPCODE(SMSG_LFG_PENDING_MATCH_DONE,                    STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    OPCODE(SMSG_INIT_EXTRA_AURA_INFO,                      STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    OPCODE(SMSG_SET_EXTRA_AURA_INFO,                       STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    OPCODE(SMSG_SET_EXTRA_AURA_INFO_NEED_UPDATE,           STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    OPCODE(SMSG_CLEAR_EXTRA_AURA_INFO,                     STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_ServerSide);
    ...
    OPCODE(CMSG_REPORT_PVP_AFK_RESULT,                     STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    ...
    OPCODE(CMSG_SPELLCLICK,                                STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL);
    ...
    OPCODE(CMSG_GROUPACTION_THROTTLED,                     STATUS_NEVER,    PROCESS_INPLACE,      &WorldSession::Handle_NULL);
