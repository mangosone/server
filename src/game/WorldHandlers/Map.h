...
class Map : public GridRefManager<NGridType>
{
    ...
    public:
        ...
        /// TBC has no phasing, so every body is in the only phase there is. The
        /// live-geometry interface is shared with the cores that do phase, and a named
        /// constant says which of the two this is rather than a bare 1.
