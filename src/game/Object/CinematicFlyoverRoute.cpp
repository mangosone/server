...
//     python .ai_tools/bake_cinematic_routes_one.py --out <this file>
//
// World-space camera routes for the ten TBC starting-race intro cinematics.
// Derived offline from TBC 2.4.3 client data: CinematicCamera.dbc provides a
// world origin and facing per cinematic (cinematicId below is that DBC row id,
// reached via ChrRaces.dbc -> CinematicSequences.dbc -> CinematicCamera.dbc);
// the referenced camera-only M2 model provides the flyby as keyframed
// position/target tracks relative to the camera base vector.
...
// (verified against playercreateinfo, 5.8-12.4 yd, camera ending on the
...
static const CinematicFlyoverRoute s_humanRoute = {
    1,     // raceId (Human)
    142,   // cinematicId (CinematicCamera.dbc ID)
...
static const CinematicFlyoverRoute s_orcRoute = {
    2,     // raceId (Orc)
    235,   // cinematicId (CinematicCamera.dbc ID)
    1,     // mapId (Kalimdor)
    70167, // durationMs
...
static const CinematicFlyoverRoute s_dwarfRoute = {
    3,     // raceId (Dwarf)
    234,   // cinematicId (CinematicCamera.dbc ID)
    0,     // mapId (Eastern Kingdoms)
    59600, // durationMs
...
static const CinematicFlyoverRoute s_nightelfRoute = {
    4,     // raceId (Night Elf)
    122,   // cinematicId (CinematicCamera.dbc ID)
    1,     // mapId (Kalimdor)
    102333, // durationMs
...
static const CinematicFlyoverRoute s_undeadRoute = {
    5,     // raceId (Undead)
    2,     // cinematicId (CinematicCamera.dbc ID)
    0,     // mapId (Eastern Kingdoms)
    102033, // durationMs
...
static const CinematicFlyoverRoute s_taurenRoute = {
    6,     // raceId (Tauren)
    202,   // cinematicId (CinematicCamera.dbc ID)
    1,     // mapId (Kalimdor)
    70333, // durationMs
...
static const CinematicFlyoverRoute s_gnomeRoute = {
    7,     // raceId (Gnome)
    162,   // cinematicId (CinematicCamera.dbc ID)
    0,     // mapId (Eastern Kingdoms)
    76667, // durationMs
...
static const CinematicFlyoverRoute s_trollRoute = {
    8,     // raceId (Troll)
    182,   // cinematicId (CinematicCamera.dbc ID)
    1,     // mapId (Kalimdor)
    57767, // durationMs
...
// Blood Elf (race 10, cinematic 243, map 530)
static const CinematicFlyoverKeyframe s_bloodelfKeyframes[] = {
    { 0, 7779.77f, -6741.42f, 54.58f, 5.7413f },
    { 4500, 7803.36f, -6752.42f, 46.92f, 5.5251f },
    { 11100, 7862.18f, -6803.41f, 65.33f, 5.6987f },
    { 12800, 7880.38f, -6820.73f, 65.33f, 5.7621f },
    { 15233, 7915.46f, -6845.79f, 65.33f, 5.8881f },
    { 17433, 7965.04f, -6868.17f, 65.33f, 5.9717f },
    { 18800, 7995.99f, -6878.12f, 66.65f, 5.9884f },
    { 21433, 8086.54f, -6900.46f, 73.22f, 5.8115f },
    { 24767, 8291.59f, -6968.51f, 103.26f, 6.2393f },
    { 26500, 8440.76f, -6989.87f, 111.54f, 0.0013f },
    { 28567, 8634.33f, -7018.19f, 72.01f, 0.0825f },
    { 28667, 8646.60f, -7018.81f, 69.56f, 0.0895f },
    { 31133, 8839.76f, -7006.83f, 35.40f, 0.0845f },
    { 32933, 8994.53f, -6989.49f, 24.68f, 0.1643f },
    { 37067, 9165.08f, -6977.87f, 46.83f, 0.0449f },
    { 42833, 9352.26f, -6862.09f, 27.03f, 0.7286f },
    { 44800, 9419.03f, -6785.08f, 27.03f, 0.1210f },
    { 47033, 9505.69f, -6770.00f, 25.43f, 0.5132f },
    { 50800, 9699.35f, -6656.66f, 9.68f, 0.5406f },
    { 53533, 9854.53f, -6571.07f, 16.22f, 0.5398f },
    { 55000, 9926.72f, -6529.60f, 21.07f, 0.5721f },
    { 59100, 10065.65f, -6367.60f, 28.69f, 0.5399f },
    { 64433, 10146.14f, -6304.29f, 58.96f, 6.0881f },
    { 70800, 10276.84f, -6294.93f, 40.15f, 5.5820f },
    { 77033, 10346.37f, -6353.01f, 35.86f, 5.5071f },
    { 79333, 10346.37f, -6353.01f, 35.86f, 5.5071f },
};

static const CinematicFlyoverRoute s_bloodelfRoute = {
    10,    // raceId (Blood Elf)
    243,   // cinematicId (CinematicCamera.dbc ID)
    530,   // mapId (Outland)
    79333, // durationMs
...
// Draenei (race 11, cinematic 244, map 530)
static const CinematicFlyoverKeyframe s_draeneiKeyframes[] = {
    { 0, -4140.30f, -11930.50f, 153.79f, 0.8294f },
    { 15867, -4060.68f, -11951.33f, 6.06f, 0.9720f },
    { 21033, -4081.65f, -12036.69f, 3.76f, 1.1582f },
    { 25967, -4126.76f, -12170.32f, 13.99f, 1.0380f },
    { 30767, -4146.23f, -12239.93f, 46.24f, 4.7034f },
    { 33600, -4154.79f, -12308.65f, 75.90f, 4.6031f },
    { 39500, -4243.40f, -12783.76f, 39.31f, 4.5870f },
    { 42833, -4275.56f, -13107.11f, 98.02f, 4.8338f },
    { 45300, -4270.15f, -13290.13f, 124.69f, 5.0445f },
    { 47400, -4260.25f, -13413.38f, 145.70f, 5.2336f },
    { 51367, -4155.07f, -13557.46f, 150.98f, 4.8858f },
    { 54733, -4076.57f, -13685.00f, 153.24f, 4.8232f },
    { 56433, -4032.31f, -13738.80f, 156.60f, 3.8925f },
    { 60200, -4011.55f, -13848.05f, 163.11f, 2.1167f },
    { 69600, -3958.91f, -13936.08f, 102.92f, 2.1211f },
    { 71667, -3958.91f, -13936.08f, 102.92f, 2.1211f },
};

static const CinematicFlyoverRoute s_draeneiRoute = {
    11,    // raceId (Draenei)
    244,   // cinematicId (CinematicCamera.dbc ID)
    530,   // mapId (Outland)
    71667, // durationMs
