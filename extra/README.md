...
|---|---|
| [`doc/`](doc/) | All project documentation, and the Doxygen configuration that turns the annotated headers under `src/` into browsable API docs. This is the former top-level `doc/`. |
...
- [`doc/ChangeLog.txt`](doc/ChangeLog.txt) — the working-session fix log, formerly at the repository root.
